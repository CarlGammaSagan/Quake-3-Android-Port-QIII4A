...
void RB_AddQuadStampExt( vec3_t origin, vec3_t left, vec3_t up, byte *color, float s1, float t1, float s2, float t2 ) {
	...
	tess.indexes[ tess.numIndexes ] = (short)ndx;
	tess.indexes[ tess.numIndexes + 1 ] = (short)(ndx + 1);
	tess.indexes[ tess.numIndexes + 2 ] = (short)(ndx + 3);

	tess.indexes[ tess.numIndexes + 3 ] = (short)(ndx + 3);
	tess.indexes[ tess.numIndexes + 4 ] = (short)(ndx + 1);
	tess.indexes[ tess.numIndexes + 5 ] = (short)(ndx + 2);
